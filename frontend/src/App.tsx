          ...
          <aside className="rounded-3xl border border-slate-800 bg-slate-900/80 p-6">
            ...
            <div className="space-y-3 text-sm text-slate-300">
              ...
              {[
                ...
                "Blank, duplicate & suspicious mobile numbers",
                "Duplicate image references",
                "Screenshot-like image names",
                "Hindi information detection",
                "Shop image presence",
            ...
            <div className="mb-5 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-400">
                  Two sheets have been created. Missing latitude/longitude values are highlighted in red and are not discarded.
                </p>
